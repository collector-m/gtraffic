...
public class OV2DFrame extends JFrame implements ActionListener,Runnable{
    ...
    void init(){
	so.init();  // call init of Solve.java
    }
    
    public void run(){
	System.out.println("run");
	Solve.TRF_API.INSTANCE.trf_init2Dim(Solve.N);
	while(th != null){  // if "reset" button is pushed, then th become null
	...
	Solve.TRF_API.INSTANCE.trf_exit2Dim();  // clean up CUDA
